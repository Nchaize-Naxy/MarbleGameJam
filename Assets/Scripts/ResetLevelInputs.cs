...
//     version 1.16.0
//     from Assets/Scripts/ResetLevelInputs.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/ResetLevelInputs.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @ResetLevelInputs: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @ResetLevelInputs()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""ResetLevelInputs"",
    ""maps"": [
        {
            ""name"": ""Keyboard"",
            ""id"": ""370a7fa8-67ad-49b9-9497-8d654089b5ea"",
            ""actions"": [
                {
                    ""name"": ""ResetLevel"",
                    ""type"": ""Button"",
                    ""id"": ""47fd0f96-822d-4192-a180-33f0a12b7fec"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""852c281a-b5e3-482a-973a-89ae4923cf6b"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Keyboard_ResetLevel = m_Keyboard.FindAction("ResetLevel", throwIfNotFound: true);
    }

    ~@ResetLevelInputs()
    {
        UnityEngine.Debug.Assert(!m_Keyboard.enabled, "This will cause a leak and performance issues, ResetLevelInputs.Keyboard.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Keyboard_ResetLevel;
    /// <summary>
    /// Provides access to input actions defined in input action map "Keyboard".
    /// </summary>
    public struct KeyboardActions
    {
        private @ResetLevelInputs m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public KeyboardActions(@ResetLevelInputs wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Keyboard/ResetLevel".
        /// </summary>
        public InputAction @ResetLevel => m_Wrapper.m_Keyboard_ResetLevel;
        /// <summary>
